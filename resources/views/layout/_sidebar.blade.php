        ...
        <div class="navbar-wrapper ">
            ...
            <div class="navbar-content scroll-div">
                <ul class="nav pcoded-inner-navbar">
                    ...
                    <li class="nav-item pcoded-hasmenu">
                        <a href="#!" class="nav-link"><span class="pcoded-micon"><i class="feather icon-book"></i></span><span class="pcoded-mtext">Laporan</span></a>
                        <ul class="pcoded-submenu">
                           <li class=""><a href="{{url('/laporan')}}" class="">Laporan</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
