...
<div class="col-md-12">
    <div class="row">
        <div class="col-sm-12">
            <form action="{{route('stock-opname.store')}}" method="POST" id="form-barang">
                @csrf
                <div class="card">
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">Barang Opname</h5>
                    ...
                    <div class="card-body">
                        <div class="item-wrapper">
                            <div class="row item-group mb-2">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>Nama Bardang</label>
                                        <select class="form-control select-barang" name="stock_opname[0][barang_id]">
                                            <option value="">-- Pilih Barang Opname --</option>
                                            @foreach($data as $item)
                                                <option value="{{ $item->id }}" {{ old('stock_opname.0.barang_id') == $item->id ? 'selected' : '' }}>{{ $item->nama_barang }}</option>
                                            @endforeach
                                        </select>
