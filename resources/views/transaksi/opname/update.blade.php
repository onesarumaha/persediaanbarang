...
<div class="col-md-12">
    <div class="row">
        <div class="col-sm-12">
            <form action="{{route('stock-opname.update',  $opname->id)}}" method="POST" id="form-barang">
                @csrf
                @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" name="tanggal" value="{{ old('tanggal', $opname->tanggal) }}">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="3" name="deskripsi">{{ old('deskripsi', $opname->deskripsi) }}</textarea>
                        ...
                        <div class="item-wrapper">
                            @forelse($opnameItems as $index => $item)
                                <div class="row item-group mb-2">
                                    <input type="hidden" name="stock_opname[{{ $index }}][id]" value="{{ $item->id }}" />
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>Nama Barang</label>
                                            <select class="form-control select-barang" name="stock_opname[{{ $index }}][barang_id]">
                                                <option value="">-- Pilih Barang --</option>
                                                @foreach($data as $barang)
                                                    <option value="{{ $barang->id }}" {{ old('stock_opname.'.$index.'.barang_id', $item->barang_id) == $barang->id ? 'selected' : '' }}>{{ $barang->nama_barang }}</option>
                                                @endforeach
                                            </select>
                                            @error('stock_opname.'.$index.'.barang_id')
                                                <div class="text-danger"><small>{{ $message }}</small></div>
                                            @enderror
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control quantity-input" name="stock_opname[{{ $index }}][quantity]" value="{{ old('stock_opname.'.$index.'.quantity', $item->quantity) }}" style="padding: 0.2rem 0.4rem; font-size: 15px; height: 30px; line-height: 1.2;">
                                            @error('stock_opname.'.$index.'.quantity')
                                                <div class="text-danger"><small>{{ $message }}</small></div>
                                            @enderror
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label>Note</label>
                                            <textarea class="form-control" rows="0" name="stock_opname[{{ $index }}][deskripsi]" style="padding: 0.2rem 0.4rem; font-size: 15px; height: 30px; line-height: 1.2;">{{ old('stock_opname.'.$index.'.deskripsi', $item->deskripsi) }}</textarea>
                                        </div>
                                    </div>
                            ...
                            @empty
                                <div class="row item-group mb-2">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>Nama Barang</label>
                                            <select class="form-control select-barang" name="stock_opname[0][barang_id]">
                                                <option value="">-- Pilih Barang --</option>
                                                @foreach($data as $barang)
                                                    <option value="{{ $barang->id }}" {{ old('stock_opname.0.barang_id') == $barang->id ? 'selected' : '' }}>{{ $barang->nama_barang }}</option>
                                                @endforeach
                                            </select>
                                            @error('stock_opname.0.barang_id')
                                                <div class="text-danger"><small>{{ $message }}</small></div>
                                            @enderror
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label>Quantity</label>
                                            <input type="text" class="form-control quantity-input" name="stock_opname[0][quantity]" value="{{ old('stock_opname.0.quantity') }}" style="padding: 0.2rem 0.4rem; font-size: 15px; height: 30px; line-height: 1.2;">
                                            @error('stock_opname.0.quantity')
                                                <div class="text-danger"><small>{{ $message }}</small></div>
                                            @enderror
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label>Note</label>
                                            <textarea class="form-control" rows="0" name="stock_opname[0][deskripsi]" style="padding: 0.2rem 0.4rem; font-size: 15px; height: 30px; line-height: 1.2;">{{ old('stock_opname.0.deskripsi') }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-2 d-flex align-items-end mb-3">
                                        <button type="button" class="btn btn-danger btn-sm btn-remove"><b>Hapus</b></button>
    ...
    function createItemTemplate(index) {
        ...
        <div class="row item-group mb-2">
            ...
            <div class="col-md-2">
                <div class="form-group">
                    <label>Quantity</label>
                    <input type="text" class="form-control quantity-input" name="stock_opname[${index}][quantity]" style="padding: 0.2rem 0.4rem; font-size: 15px; height: 30px; line-height: 1.2;">
                    <div class="invalid-feedback"></div>
                </div>
            </div>
            <div class="col-md-2">
                <div class="form-group">
                    <label>Note</label>
                    <textarea class="form-control" rows="1" name="stock_opname[${index}][deskripsi]" style="padding: 0.2rem 0.4rem; font-size: 15px; height: 30px; line-height: 1.2;"></textarea>
                </div>
            </div>
            <div class="col-md-2 d-flex align-items-end mb-3">
                <button type="button" class="btn btn-danger btn-sm btn-remove"><b>Hapus</b></button>
